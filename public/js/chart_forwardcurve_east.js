...
for (var i in daily_data_list) {
    ...
    if (i % 12 == 0) {
        var value = format_value(daily_data_list[i]['price']) * i / 15;
    } else {
        var value = format_value(daily_data_list[i]['price']) * i / 50;
    }
    chartData[j] = ({
        date: format_date,
        daily: format_value(value), // 2016/03/15
    });
    j++;
}

var chart = AmCharts.makeChart("chart_forwardcurve_east", {
    type: "stock",
    theme: "light",
    ...
    "export": {
        ...
        "menu": [{
                ...
                "fileName": "ForwardCurve_Daily_" + export_date + "_east"   // 2017/01/02
            }]
    }
});
