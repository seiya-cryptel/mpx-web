...
for (var j in line_title_list) {
    ...
    // line_title_list[i] = dt.getFullYear() + "/" + (dt.getMonth() + 1);
    line_title_list[i] = month_english_list[dt.getMonth()] + ' ' + dt.getFullYear();
...
var chart_coal2 = AmCharts.makeChart("chartdiv_hst_demands", {
    ...
    panels: [{
            ...
            title: "Forward Curve Trends (JPY/kWh)",
