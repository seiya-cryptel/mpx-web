...
for (var i in demand_forecast_data_list) {
    ...
    var assumption_hydro = demand_forecast_data_list[i]['hydro'];
    chartData[i] = ({
        date: format_date,
        assumption_hydro: assumption_hydro
    });
}

var chart_solar = AmCharts.makeChart("chartdiv_hydro", {
    type: "stock",
    theme: "light",
    ...
    dataSets: [{
            fieldMappings: [
                {
                    fromField: "assumption_hydro",
                    toField: "assumption_hydro"
                }
            ],
    ...
    "export": {
        ...
        "menu": [{
                ...
                "fileName": "Assumption_Hydro_" + export_date + filename_area
            }]
    }
});
