...
for (var i in demand_forecast_data_list) {
    ...
    var assumption_solar = demand_forecast_data_list[i]['solar'];
    chartData[i] = ({
        date: format_date,
        assumption_solar: assumption_solar
    });
}

var chart_solar = AmCharts.makeChart("chartdiv_solar", {
    type: "stock",
    theme: "light",
    ...
    dataSets: [{
            fieldMappings: [
                {
                    fromField: "assumption_solar",
                    toField: "assumption_solar"
                }
            ],
    ...
    "export": {
        ...
        "menu": [{
                ...
                "fileName": "Assumption_Solar_" + export_date + filename_area
            }]
    }
});
