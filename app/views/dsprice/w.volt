...
<div class="row">
    ...
    <div class="col-xs-12 mt30">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="active"><a href="#" data-toggle="tab" role="tab">西エリア</a></li>
        ...
        <div id="tabContent2" class="tab-content">
            <div class="tab-pane fade in active" id="short">  
                <h2>JEPXスポット価格予測（1か月）（西エリア）{{ ds_upload_date }} 計算</h2>
		...
		<div id="onemonthprice_area">
                ...
                <br>
                <h2>Generation Stack (Hourly)（西エリア）{{ ds_upload_date }} 計算</h2>
