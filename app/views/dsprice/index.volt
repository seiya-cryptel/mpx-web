...
<div class="row">
    ...
    <div class="col-xs-12 mt30">
		...
		<div id="onemonthprice_area">
                ...
                <br>
                <h2>Generation Stack (Hourly)（システム）{{ ds_upload_date }} 計算</h2>
