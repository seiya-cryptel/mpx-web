    ...
    <div class="col-xs-12 mt30">
        ...
        <div id="tabContent2" class="tab-content">
            <div class="tab-pane fade in active" id="short">  
                <h2>JEPX Spot Price Forecast (1month) (East Area) {{ ds_upload_date }} </h2>
...
<!-- Generation Stack (Hourly)（システム） -->
                <h2 class="generationstack_area clearfix">Generation Stack (Hourly) (East Area){{ ds_upload_date }} </h2>
