...
<div class="row">
    ...
    <div class="col-xs-12 mt30">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="active"><a href="#" data-toggle="tab" role="tab">Hokkaido Area Price</a></li>
            <li><a href="/dsprice/ke">Kyushu Area Price</a></li>
        </ul>
        
        <div id="tabContent2" class="tab-content">
            <div class="tab-pane fade in active" id="short">  
                <h2>JEPX Spot Price Forecast (1month) (Hokkaido Area) {{ ds_upload_date }} </h2>
...
<!-- Generation Stack (Hourly)（システム） -->
                <h2 class="generationstack_area clearfix">Generation Stack (Hourly) (Hokkaido Area){{ ds_upload_date }} </h2>
