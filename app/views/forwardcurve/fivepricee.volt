{# viusageNoticee2'ws/forwardcurve/fivepricee.volt #}
<div class="row">
    ...
    <div class="col-xs-12 mt30">
        ...
        {% if enable_5area %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="/forwardcurve/fiveprice/">5 Area Price</a></li>
            </ul>
        {% endif %}
        <div id="tabContent3" class="tab-content">
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    {# form("forwardcurve/fiveprice", 'id': 'calender') #}
                    {{ form("forwardcurve/fivepricee", 'id': 'calender') }}
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>Power Forward Curve (5 Area Price) {{ monthly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>Power Forward Curve (5 Area Price) {{ daily_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>Power Forward Curve (5 Area Price) {{ half_hourly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>Power Forward Curve (5 Area Price) {{ hourly_upload_date }}</h2>
