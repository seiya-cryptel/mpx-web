    ...
    <div class="col-xs-12 mt30">
        ...
        {% if enable_5area %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price">Kyushu Area Price</a></li>
        ...
        <div id="tabContent3" class="tab-content">
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    {{ form("forwardcurve/kpricee", 'id': 'calender') }}
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>Power Forward Curve (Kyushu Area Price) {{ monthly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>Power Forward Curve (Kyushu Area Price) {{ daily_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>Power Forward Curve (Kyushu Area Price) {{ half_hourly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>Power Forward Curve (Kyushu Area Price) {{ hourly_upload_date }}</h2>
