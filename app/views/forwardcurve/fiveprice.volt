{# views/forwardcurve/fiveprice.volt #}
<div class="row">
    ...
    <div class="col-xs-12 mt30">
        ...
        {% if enable_5area %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="/forwardcurve/fiveprice/">5エリアプライス</a></li>
            </ul>
        {% endif %}
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>電力フォワードカーブ（５エリア） {{ monthly_upload_date }} 配信</h2>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>電力フォワードカーブ（５エリア） {{ daily_upload_date }} 配信</h2>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>電力フォワードカーブ（５エリア） {{ half_hourly_upload_date }} 配信</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>電力フォワードカーブ（５エリア） {{ hourly_upload_date }} 配信</h2>
