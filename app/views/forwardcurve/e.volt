        ...
        <div id="tabContent3" class="tab-content">
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    {# form("forwardcurve", 'id': 'calender') #}
                    {{ form("forwardcurve/e", 'id': 'calender') }}
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>Power Forward Curve (System Price) {{ monthly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>Power Forward Curve (System Price) {{ daily_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>Power Forward Curve (System Price) {{ half_hourly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>Power Forward Curve (System Price) {{ hourly_upload_date }}</h2>
