{# views/forwardcurve/westpricee.volt #}
    ...
    <div class="col-xs-12 mt30">
        ...
        {% if enable_5area %}
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="/forwardcurve/e">System Price</a></li>{# 2020/03/01 #}
                <li><a href="/forwardcurve/eastpricee/">East Area Price</a></li>
                <li class="active"><a href="#system_price">West Area Price</a></li>
        ...
        <div id="tabContent3" class="tab-content">
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    {# form("forwardcurve/westprice", 'id': 'calender') #}
                    {{ form("forwardcurve/westpricee", 'id': 'calender') }}
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>Power Forward Curve (West Area Price) {{ monthly_upload_date }}</h2>
                        ...
                        <div class="row clearboth mt30">
                            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <p class="p_indent size_att">* “West Area” refers to Chubu, Hokuriku, Kansai, Chugoku and Shikoku areas (excluding Kyushu area).</p>{# 2020/03/01 #}
                                </div>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>Power Forward Curve (West Area Price) {{ daily_upload_date }}</h2>
                        <div id="chartdiv" class="forwardcurve_chart"></div><br>

                        <div class="row clearboth mt30">
                            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                                <div class="alert alert-info" role="alert">
                                    <p class="p_indent size_att">* “West Area” refers to Chubu, Hokuriku, Kansai, Chugoku and Shikoku areas (excluding Kyushu area).</p>
                                </div>
                                {{ partial('shared/usageNoticee2') }}
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>Power Forward Curve (West Area Price) {{ half_hourly_upload_date }}</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>Power Forward Curve (West Area Price) {{ hourly_upload_date }}</h2>
