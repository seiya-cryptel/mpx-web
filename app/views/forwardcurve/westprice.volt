{# views/forwardcurve/westprice.volt #}
    ...
    <div class="col-xs-12 mt30">
        ...
        {% if enable_5area %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price">西エリアプライス</a></li>
                <!-- <li><a href="/forwardcurve/threeprice/">3エリアプライス</a></li> -->
                <li><a href="/forwardcurve/hprice/">北海道エリアプライス</a></li>
                <li><a href="/forwardcurve/kprice/">九州エリアプライス</a></li>
            ...
            <div class="tab-pane fade in active" id="system_price">
                ...
                <div id="tabContent2" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="monthly">
                        <h2>電力フォワードカーブ（西エリアプライス） {{ monthly_upload_date }} 配信</h2>
                        <div id="monthly_chart" class="forwardcurve_chart"></div>

                        <div class="row clearboth mt30">
                            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                                <div class="alert alert-info" role="alert">
                                    <p class="p_indent size_att">※ベースロードは24時間平均、日中ロード(daytime)は平日8:00-18:00の平均、ピークロードは平日13:00-16:00の平均です。また、当限はJEPXの実績値と残りの期間のフォワード価格の平均値です。</p>
                                    <p class="p_indent size_att">※「西エリア」は、九州を除く西日本（中部・北陸・関西・中国・四国）エリアを示してしています。</p>
                                </div>
                    ...
                    <div class="tab-pane fade" id="daily">
                        <h2>電力フォワードカーブ（西エリアプライス） {{ daily_upload_date }} 配信</h2>
                    ...
                    <div class="tab-pane fade" id="half_hourly">  
                        <h2>電力フォワードカーブ（西エリアプライス） {{ half_hourly_upload_date }} 配信</h2>
                    ...
                    <div class="tab-pane fade" id="hourly">  
                        <h2>電力フォワードカーブ（西エリアプライス） {{ hourly_upload_date }} 配信</h2>
