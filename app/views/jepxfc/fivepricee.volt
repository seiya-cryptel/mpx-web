...
<div class="row">
    ...
    <div class="col-xs-12 mt30">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="active"><a href="#" data-toggle="tab" role="tab">5 Area Price</a></li>
        </ul>
        
        <div id="tabContent2" class="tab-content">
            <div class="tab-pane fade in active" id="short">  
                <h2>JEPX Spot Price Forecast (5 Area Price)
 {{ jepx_upload_date }} Delivery</h2>
