...
<div style="width:90%;max-width:1000px;padding:20px;margin:0 auto;"min-height: 0;margin-bottom:0;"id="left_content">
    <h2 style="padding:8px 8px 20px 20px;border-left: solid 8px #196c9e;border-bottom: solid 5px #196c9e;font-size: 20px;">お知らせ登録・編集・削除
    </h2>
</div>
...
<div style="width:65%;margin:0 auto;">
    ...
    {% if updateMode == 'new' %}
        {{ form("management/newscreate", 'style': 'text-align: center; width: 100%; border-radius: 5px; border-color: #558cba;') }}
    {% else %}
        {{ form("management/newssave", 'style': 'text-align: center; width: 100%; border-radius: 5px; border-color: #558cba;') }}
    {% endif %}
    {{ form.render('id') }}
    ...
    <tr>　　　　　　　
        <td style="background-color: #558cba; color: white; padding:  7px; text-align: center; width: 40%;" >内容</td>　 
        <td style="padding: 10px;border: 1px solid #black;">
            {{ form.render('content', ['style': "text-align: center; width: 100%; border-radius: 5px; border-color: #558cba;"]) }}
        </td>　    
    </tr>　　　　　　 

    <tr>
        <td style="background-color: #558cba; color: white; padding:  7px; text-align: center; width: 40%;" >URL</td>
        <td style="padding: 10px;border: 1px solid #black;">
            {{ form.render('url', ['style': "text-align: center; width: 100%; border-radius: 5px; border-color: #558cba;"]) }}
        </td>　    
    </tr>

    {# 2020/01/28 #}
    <tr>
        <td style="background-color: #558cba; color: white; padding:  7px; text-align: center; width: 40%;" >URL 英語用</td>
        <td style="padding: 10px;border: 1px solid #black;">
            {{ form.render('url_e', ['style': "text-align: center; width: 100%; border-radius: 5px; border-color: #558cba;"]) }}
        </td>　    
    </tr>
