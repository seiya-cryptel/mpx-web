<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        <ul id="pointTab" class="nav nav-tabs" role="tablist">
            ...
            <li class="active"><a href="#kitahon" data-toggle="tab" role="tab">Hokkaido-Tohoku Interconnecter</a></li>
            <li><a href="/prerequisite/interconnectkanmone">Chugoku-Kyushu Interconnector</a></li>
        </ul>

        <div id="tabContent" class="tab-content">
            <div class="tab-pane fade in active" id="kitahon">
                <h2>Assumed Avilable Capacity of Interconnector (Hokkaido-Tohoku Interconnecter)</h2>
