{# views/prerequisite/capacityeast.volt #}
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        {% if enable_capacity_all_menu %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price" data-toggle="tab" role="tab">East Area</a></li>
        ...
        <div class="tab-pane fade in active" id="jepx4">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <h2>Assumed Availability Capacity of Thermal Generation (East Area) {{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="tab2">
                    <h2>Assumed Availability Capacity of Nuclear Generation (East Area) {{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="sunlight">
                    <h2>Assumed Solar Generation (East Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="wind_power">
                    <h2>Assumed Wind Generation (East Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="geothermal_power">
                    <h2>Assumed Geothermal Generation (East Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="biomass">
                    <h2>Assumed Biomass Generation (East Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro">
                    <h2>Assumed Hydro Generation (East Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro_pump">
                    <h2>Assumed Pumped Hydro Generation (East Area)</h2>
