{# views/prerequisite/demandandrenewableenergyeast.volt #}
<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">   
        ...
        {% if enable_demand_all_menu %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a href="/prerequisite/demandandrenewableenergyweste/">Westt Area</a></li>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="residual_load">
                    <h2>Assumed Residual Load (East Area)</h2>
