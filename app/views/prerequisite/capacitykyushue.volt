{# views/prerequisite/capacitykyushu.volt #}
<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        {% if role==4 or role==6 or role==8 or role==9 %} {# PlanB2, C2, D2, Admin #}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price" data-toggle="tab" role="tab">Kyushu Area</a></li>
            </ul>
        {% endif %}
        ...
        <div class="tab-pane fade in active" id="jepx4">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <h2>Assumed Availability Capacity of Thermal Generation (Kyushu Area) {{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="tab2">
                    <h2>Assumed Availability Capacity of Nuclear Generation (Kyushu Area) {{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="sunlight">
                    <h2>Assumed Solar Generation (Kyushu Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="wind_power">
                    <h2>Assumed Wind Generation (Kyushu Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="geothermal_power">
                    <h2>Assumed Geothermal Generation (Kyushu Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="biomass">
                    <h2>Assumed Biomass Generation (Kyushu Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro">
                    <h2>Assumed Hydro Generation (Kyushu Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro_pump">
                    <h2>Assumed Pumped Hydro Generation (Kyushu Area)</h2>
