{# views/prerequisite/fuelcif.volt #}
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">   
        ...
        <div class="tab-pane fade in active" id="jepx4">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab1" data-toggle="tab">石油CIF価格想定</a></li>
                {% if show202207 %}
                <li><a href="#tab5" data-toggle="tab">石油CIF価格想定（追加調達）</a></li> {# 2022/07/11 #}
                {% endif %}
                <li><a href="#tab2" data-toggle="tab">LNG CIF価格想定</a></li>
                <li><a href="#tab4" data-toggle="tab">LNG CIF価格想定（追加調達）</a></li> {# 2022/03/17 202203-03 #}
                <li><a href="#tab3" data-toggle="tab">石炭CIF価格想定</a></li>
                {% if show202207 %}
                <li><a href="#tab6" data-toggle="tab">石炭CIF価格想定（追加調達）</a></li> {# 2022/07/11 #}
                {% endif %}
            </ul>
            <div class="tab-content">
                {{ form("prerequisite/fuelcif", 'id': 'calender') }}
                ...
                <div class="tab-pane active" id="tab1">
                    <h2>石油CIF価格 {{ oil_lng_coal_upload_date }} 想定</h2>
                    <div id="chartdiv_sub_oil" class="chart_fuel"></div><br><br>
                    {% set fuel_type = '原油' %}
                    {{ partial('shared/sourceLNGAdd') }}{# 2022/03/17 202203-04 #}
                    {{ partial('shared/usageNotice') }}
                </div>
                {% if show202207 %}
                <div class="tab-pane active" id="tab5">
                    <h2>石油CIF価格（追加調達） {{ oil_lng_coal_upload_date }} 想定</h2>
                ...
                <div class="tab-pane" id="tab2">
                    <h2>LNG CIF価格 {{ oil_lng_coal_upload_date }} 想定</h2>
                    <div id="chartdiv_sub_lng" class="chart_fuel"></div><br><br>
                    {% set fuel_type = '原油およびLNG' %}{# 2022/03/18 #}
                    {{ partial('shared/sourceLNGAdd') }}{# 2022/03/17 202203-04 #}
                    {{ partial('shared/usageNotice') }}
                </div>
                {# 2022/03/17 202203-03 #}
                <div class="tab-pane" id="tab4">
                    <h2>LNG CIF価格（追加調達） {{ oil_lng_coal_upload_date }} 想定</h2>
                ...
                <div class="tab-pane" id="tab3">
                    <h2>石炭CIF価格 {{ oil_lng_coal_upload_date }} 想定</h2>
                    <div id="chartdiv_sub_coal" class="chart_fuel"></div><br><br>
                    <p> 参考）gC NEWC Futures Curve (globalCOAL) </p>
                    {{ partial('shared/usageNotice') }}
                </div>
                {% if show202207 %}
                <div class="tab-pane" id="tab6">
                    <h2>石炭CIF価格（追加調達） {{ oil_lng_coal_upload_date }} 想定</h2>
