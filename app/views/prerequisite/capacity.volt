...
<div class="col-xs-10 col-sm-10 col-md-10">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#system_price" data-toggle="tab" role="tab">全国エリア</a></li>
