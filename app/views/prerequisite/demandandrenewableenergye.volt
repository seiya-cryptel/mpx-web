{# views/prerequisite/demandandrenewableenergy.volt #}
<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">   
        ...
        <div class="tab-pane fade in active" id="jepx3">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="demand">
                    <h2>Assumed Load (Nationwide(System))</h2>
                    <div id="chartdiv_demand_forecast" class="chart_demandandrenewableenergy"></div><br>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="residual_load">
                    <h2>Assumed Residual Load (Nationwide(System))</h2>
                    <div id="chartdiv_residual_load" class="chart_demandandrenewableenergy"></div><br>
		<div class="row alert_area"><br>
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
