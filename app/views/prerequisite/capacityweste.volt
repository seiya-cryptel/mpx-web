{# views/prerequisite/capacitywest.volt #}
<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        {% if role==4 or role==6 or role==8 or role==9 %} {# PlanB2, C2, D2, Admin #}
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="/prerequisite/capacitye/">Nationwide (System)</a></li>
                <li><a href="/prerequisite/capacityeaste/">East Area</a></li>
                <li class="active"><a href="#system_price" data-toggle="tab" role="tab">West Area</a></li>
        ...
        <div class="tab-pane fade in active" id="jepx4">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <h2>Assumed Availability Capacity of Thermal Generation (West Area) {{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="tab2">
                    <h2>Assumed Availability Capacity of Nuclear Generation (West Area){{ supply_capacity_assumed_datee }}</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="sunlight">
                    <h2>Assumed Solar Generation (West Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="wind_power">
                    <h2>Assumed Wind Generation (West Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="geothermal_power">
                    <h2>Assumed Geothermal Generation (West Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="biomass">
                    <h2>Assumed Biomass Generation (West Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro">
                    <h2>Assumed Hydro Generation (West Area)</h2>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="hydro_pump">
                    <h2>Assumed Pumped Hydro Generation (West Area)</h2>
