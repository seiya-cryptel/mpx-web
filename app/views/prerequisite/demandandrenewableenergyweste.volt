{# views/prerequisite/demandandrenewableenergywest.volt #}
<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">   
        ...
        {% if enable_demand_all_menu %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a href="/prerequisite/demandandrenewableenergyhe/">Hokkaido Area</a></li>
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                ...
                <div class="tab-pane" id="residual_load">
                    <h2>Assumed Residual Load (West Area)</h2>
                    <div id="chartdiv_residual_load" class="chart_demandandrenewableenergy region_residual_area"></div><br>

		<div class="row alert_area"><br>
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">  
                    <div class="alert alert-info" role="alert">
                        <p class="p_indent size_att">* "Residual demand" is demand minus renewable generation.</p>
                        <p class="p_indent size_att">* “West Area” refers to Chubu, Hokuriku, Kansai, Chugoku and Shikoku Areas (excluding Kyushu Area).</p>
                    </div>
                    {{ partial('shared/usageNoticee') }}
                </div>
