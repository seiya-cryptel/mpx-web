    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        {% if role==4 or role==6 or role==8 or role==9 %} {# PlanB2, C2, D2, Admin #}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price" data-toggle="tab" role="tab">西エリア</a></li>
                <li><a href="/prerequisite/capacityhokkaido/">北海道エリア</a></li>
        ...
        <div class="tab-pane fade in active" id="jepx4">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <h2>火力供給力（西エリア）{{ supply_capacity_assumed_date }} 想定</h2>
                ...
                <div class="tab-pane" id="tab2">
                    <h2>原子力供給力（西エリア）{{ supply_capacity_assumed_date }} 想定</h2>
