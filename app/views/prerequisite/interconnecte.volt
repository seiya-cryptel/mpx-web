<div class="row mt30">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        <ul id="pointTab" class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#conv" data-toggle="tab" role="tab">Frequency Conversion Facility </a></li>
        ...
        <div id="tabContent" class="tab-content">
            <div class="tab-pane fade in active" id="conv">
                <h2>Assumed Avilable Capacity of Interconnector (Frequency Conversion Facility)</h2>
