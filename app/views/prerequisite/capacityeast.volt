    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        {% if enable_capacity_all_menu %}
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#system_price" data-toggle="tab" role="tab">東エリア</a></li>
        ...
        <div class="tab-pane fade in active" id="jepx4">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <h2>火力供給力（東エリア）{{ supply_capacity_assumed_date }} 想定</h2>
                ...
                <div class="tab-pane" id="tab2">
                    <h2>原子力供給力（東エリア）{{ supply_capacity_assumed_date }} 想定</h2>
